  ...
  return (
    <div className="main-content">
      ...
      <header className="header" style={{ marginBottom: '1rem' }}>
        ...
        <p className="subtitle">{t('podcast.subtitle')}</p>
      </header>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <h2 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800 }}>{t('podcast.ascolta.titolo')}</h2>
        </div>
      ...
      >
        ...
        <motion.a
          ...
          whileHover={{ scale: 1.05 }}
        >
          <ExternalLink size={15} /> {t('podcast.cta.inizia')}
        </motion.a>
      </motion.div>
    </div>
  );
