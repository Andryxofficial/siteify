  ...
  return (
    <div className="main-content">
      ...
      <header style={{ marginBottom: '1.5rem', textAlign: 'center' }}>
        ...
        <p className="subtitle">{t('instagram.subtitle')}</p>
      </header>
      ...
      >
        ...
        <div style={{
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Instagram size={18} /> {t('instagram.cta.segui')}
          </motion.a>
        </div>
      </motion.div>
      ...
      >
        ...
        >
          <ExternalLink size={16} /> {t('instagram.cta.stories')}
        </motion.a>
      </motion.div>
    </div>
  );
