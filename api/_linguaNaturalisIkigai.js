...
const ROTTE = {
  it: { '/': 'Home', '/socialify': 'SOCIALify', '/socialify/info-tag': 'Info tag', '/gioco': 'Giochi', '/chat': 'Chat', '/messaggi': 'Messaggi', '/amici': 'Amici', '/impostazioni': 'Impostazioni', '/twitch': 'Twitch', '/profilo': 'Profilo', '/privacy': 'Privacy', '/chi-sono': 'Chi sono', 'https://mandymashwear.it/': 'Mandy Mash Wear' },
  en: { '/': 'Home', '/socialify': 'SOCIALify', '/socialify/info-tag': 'Tag info', '/gioco': 'Games', '/chat': 'Chat', '/messaggi': 'Messages', '/amici': 'Friends', '/impostazioni': 'Settings', '/twitch': 'Twitch', '/profilo': 'Profile', '/privacy': 'Privacy', '/chi-sono': 'About me', 'https://mandymashwear.it/': 'Mandy Mash Wear' },
  es: { '/': 'Inicio', '/socialify': 'SOCIALify', '/socialify/info-tag': 'Info etiquetas', '/gioco': 'Juegos', '/chat': 'Chat', '/messaggi': 'Mensajes', '/amici': 'Amigos', '/impostazioni': 'Ajustes', '/twitch': 'Twitch', '/profilo': 'Perfil', '/privacy': 'Privacidad', '/chi-sono': 'Quién soy', 'https://mandymashwear.it/': 'Mandy Mash Wear' },
};
