...
const IT = {
  ...
  engine: {
    ...
    inv_hp: 'Vita',
    inv_tools: 'STRUMENTI',
    inv_crystals: 'CRISTALLI',
    inv_consumables: 'OGGETTI',
    inv_quest: 'MISSIONE',
    inv_zone: 'ZONA',
    inv_kills: 'Nemici',
    inv_bosses: 'Boss',
    inv_hint: '[I/Tab/M] chiudi  ·  [P] usa pozione',
    /* Toast pozione */
    no_potion: '✗ Nessuna pozione',
    full_hp: '✓ Vita già piena',
    potion_used: '🧪 Pozione usata!',
    /* Quest hints */
    quest_start: 'Parla con il Re Andryx nel villaggio per iniziare l\'avventura.',
    quest_sword: 'Parla con l\'Anziano nella Grotta a nord-ovest del villaggio: ti darà la spada.',
    quest_shield: 'Trova lo SCUDO nella tua casa: rompi il vaso dorato per la chiave.',
    quest_forest: 'Esplora la Foresta a est: sconfiggi il Troll per il Cristallo Verde.',
    quest_cave: 'Esplora la Caverna a sud: accendi le torce e sconfiggi il Custode per il Cristallo Blu.',
    quest_castle: 'Vai a nord nel Castello: sconfiggi il Re Ombra per il Cristallo Rosso.',
    quest_final: 'Hai i 3 cristalli! Affronta il Re Ombra nel Castello.',
  },
  meta: {
...
const EN = {
  ...
  engine: {
    ...
    inv_hp: 'Health',
    inv_tools: 'TOOLS',
    inv_crystals: 'CRYSTALS',
    inv_consumables: 'ITEMS',
    inv_quest: 'QUEST',
    inv_zone: 'ZONE',
    inv_kills: 'Kills',
    inv_bosses: 'Bosses',
    inv_hint: '[I/Tab/M] close  ·  [P] use potion',
    no_potion: '✗ No potions',
    full_hp: '✓ HP already full',
    potion_used: '🧪 Potion used!',
    quest_start: 'Talk to King Andryx in the village to start your adventure.',
    quest_sword: 'Talk to the Elder in the Cave NW of the village: he\'ll give you the sword.',
    quest_shield: 'Find the SHIELD in your house: break the golden jar for the key.',
    quest_forest: 'Explore the Forest east: defeat the Troll for the Green Crystal.',
    quest_cave: 'Explore the Cave south: light the torches and beat the Guardian for the Blue Crystal.',
    quest_castle: 'Go north to the Castle: defeat the Shadow King for the Red Crystal.',
    quest_final: 'You have all 3 crystals! Face the Shadow King in the Castle.',
  },
  meta: {
...
const ES = {
  ...
  engine: {
    ...
    inv_hp: 'Vida',
    inv_tools: 'EQUIPO',
    inv_crystals: 'CRISTALES',
    inv_consumables: 'OBJETOS',
    inv_quest: 'MISIÓN',
    inv_zone: 'ZONA',
    inv_kills: 'Enemigos',
    inv_bosses: 'Jefes',
    inv_hint: '[I/Tab/M] cerrar  ·  [P] usar poción',
    no_potion: '✗ Sin pociones',
    full_hp: '✓ Vida ya llena',
    potion_used: '🧪 ¡Poción usada!',
    quest_start: 'Habla con el Rey Andryx en el pueblo para empezar la aventura.',
    quest_sword: 'Habla con el Anciano en la Cueva NO del pueblo: te dará la espada.',
    quest_shield: 'Encuentra el ESCUDO en tu casa: rompe la vasija dorada para la llave.',
    quest_forest: 'Explora el Bosque al este: derrota al Troll por el Cristal Verde.',
    quest_cave: 'Explora la Cueva al sur: enciende las antorchas y vence al Guardián por el Cristal Azul.',
    quest_castle: 'Ve al norte al Castillo: vence al Rey Sombra por el Cristal Rojo.',
    quest_final: '¡Tienes los 3 cristales! Enfrenta al Rey Sombra en el Castillo.',
  },
  meta: {
