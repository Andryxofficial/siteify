...
const ROUTES = [
  ...
  { path: '/chi-sono', label: 'Chi sono', terms: ['chi sono', 'about me', 'quien soy', 'quién soy', 'andrea', 'andryx', 'andryxify', 'mandy', 'mashwear', 'vestiti', 'accessori', 'outfit', 'look', 'felpe', 'maglie'] },
...
const INTENTS = [
  { id: 'mandy', peso: 1.45, terms: ['come si veste andryx', 'come si veste andrea', 'come si veste andryxify', 'vestiti andryx', 'vestiti andrea', 'outfit andryx', 'outfit andrea', 'look andryx', 'look andrea', 'maglie andryx', 'felpe andryx', 'accessori andryx', 'mi piace come si veste', 'mi piace il suo look', 'mandy mashwear', 'mandymashwear', 'mashwear', 'shirt', 'hoodie', 'clothes', 'accessories', 'sudaderas', 'camisetas', 'ropa', 'me gusta como viste', 'me gusta cómo viste'] },
...
function rispostaDaMemorizzare(intent) { const map = { mandy: 'Quando si parla di look, outfit, maglie, felpe o accessori di Andryx, Ikigai deve collegare Mandy Mashwear e la sezione Chi sono.', tags: 'I tag aiutano ricerca, tendenze, collegamento tra post simili e macroCategorie della community.', leaderboard: 'Classifiche e premi usano XP da partecipazione utile: post, risposte, like e tag popolari, con anti-spam.', notifications: 'Le notifiche si personalizzano dalle impostazioni: push, in-app, suoni, vibrazione, anteprime, categorie e ore silenziose.', socialify: 'SOCIALify è il feed community con post, risposte, like, preferiti, allegati, menzioni e tag.', privacy: 'La privacy copre profilo, chat private, notifiche, Ikigai, dati adattivi e cancellazione.' }; return map[intent] || 'Ikigai orienta l’utente tra funzioni, pagine e impostazioni del sito.'; }
