...
export const TRADUZIONI = {
  it: {
    ...
    'settings.notif.push.descr':     'Ricevi avvisi anche quando il sito è in background',
    'settings.notif.push.attiva':    'Attiva notifiche browser',
    'settings.notif.push.bloccate':  'Le notifiche sono bloccate dal browser. Abilita dai permessi del sito.',
    'settings.notif.suoni':          'Suoni di notifica',

    'settings.notif.sezione.canali': 'Canali',
    'settings.notif.live':           '🔴 Diretta live (Twitch)',
    'settings.notif.live.descr':     'Avviso quando ANDRYXify va in diretta',
    'settings.notif.messaggi':       '💬 Messaggi privati',
    'settings.notif.messaggi.descr': 'Avviso per ogni nuovo messaggio ricevuto',
    'settings.notif.chat':           '🗨️ Chat generale',
    'settings.notif.chat.descr':     'Avviso per nuovi messaggi nella chat pubblica',
    'settings.notif.post':           '📝 Nuovi post community',
    'settings.notif.post.descr':     'Avviso quando qualcuno pubblica un nuovo post',
    'settings.notif.risposte':       '↩️ Risposte ai tuoi post',
    'settings.notif.risposte.descr': 'Avviso quando ricevi una risposta',
    'settings.notif.likes':          '❤️ Mi piace',
    'settings.notif.likes.descr':    'Avviso quando qualcuno mette mi piace ai tuoi post',
    'settings.notif.mentions':       '@ Menzioni',
    'settings.notif.mentions.descr': 'Avviso quando vieni menzionato in chat o nei post',

    'settings.notif.sezione.sistema': 'Sistema',
    ...
    'community.editor.allega':    '📎 Allega media',
    'community.editor.allega_caricamento': 'Caricamento…',
    'community.editor.allega_rimuovi': 'Rimuovi allegato',
    'community.editor.allega_errore': 'Errore nel caricamento del media.',
    'community.editor.allega_troppo_grande': 'File troppo grande (max ~4MB dopo compressione).',
    ...
    'game.pausa':                 'Pausa',
    'game.pausa.riprendi':        '▶ Riprendi',
    'game.pausa.salva_esci':      '💾 Salva ed Esci',
    'game.pausa.esci':            '🚪 Esci senza salvare',
  ...
  en: {
    ...
    'settings.notif.push':           'Browser push notifications',
    'settings.notif.push.descr':     'Receive alerts even when the site is in the background',
    'settings.notif.push.attiva':    'Enable browser notifications',
    'settings.notif.push.bloccate':  'Notifications are blocked by the browser. Enable them in site permissions.',
    'settings.notif.suoni':          'Notification sounds',

    'settings.notif.sezione.canali': 'Channels',
    'settings.notif.live':           '🔴 Live stream (Twitch)',
    'settings.notif.live.descr':     'Alert when ANDRYXify goes live',
    'settings.notif.messaggi':       '💬 Private messages',
    'settings.notif.messaggi.descr': 'Alert for each new message received',
    'settings.notif.chat':           '🗨️ General chat',
    'settings.notif.chat.descr':     'Alert for new messages in the public chat',
    'settings.notif.post':           '📝 New community posts',
    'settings.notif.post.descr':     'Alert when someone publishes a new post',
    'settings.notif.risposte':       '↩️ Replies to your posts',
    'settings.notif.risposte.descr': 'Alert when you receive a reply',
    'settings.notif.likes':          '❤️ Likes',
    'settings.notif.likes.descr':    'Alert when someone likes your posts',
    'settings.notif.mentions':       '@ Mentions',
    'settings.notif.mentions.descr': 'Alert when you are mentioned in chat or posts',

    'settings.notif.sezione.sistema': 'System',
    ...
    'community.editor.allega':    '📎 Attach media',
    'community.editor.allega_caricamento': 'Uploading…',
    'community.editor.allega_rimuovi': 'Remove attachment',
    'community.editor.allega_errore': 'Error uploading media.',
    'community.editor.allega_troppo_grande': 'File too large (max ~4MB after compression).',
    ...
    'game.pausa':                 'Pause',
    'game.pausa.riprendi':        '▶ Resume',
    'game.pausa.salva_esci':      '💾 Save & Exit',
    'game.pausa.esci':            '🚪 Exit without saving',
  ...
  es: {
    ...
    'settings.notif.push':           'Notificaciones push del navegador',
    'settings.notif.push.descr':     'Recibe alertas incluso cuando el sitio está en segundo plano',
    'settings.notif.push.attiva':    'Activar notificaciones del navegador',
    'settings.notif.push.bloccate':  'El navegador ha bloqueado las notificaciones. Actívalas en los permisos del sitio.',
    'settings.notif.suoni':          'Sonidos de notificación',

    'settings.notif.sezione.canali': 'Canales',
    'settings.notif.live':           '🔴 Directo en vivo (Twitch)',
    'settings.notif.live.descr':     'Aviso cuando ANDRYXify va en directo',
    'settings.notif.messaggi':       '💬 Mensajes privados',
    'settings.notif.messaggi.descr': 'Aviso por cada nuevo mensaje recibido',
    'settings.notif.chat':           '🗨️ Chat general',
    'settings.notif.chat.descr':     'Aviso por nuevos mensajes en el chat público',
    'settings.notif.post':           '📝 Nuevas publicaciones',
    'settings.notif.post.descr':     'Aviso cuando alguien publica en la comunidad',
    'settings.notif.risposte':       '↩️ Respuestas a tus posts',
    'settings.notif.risposte.descr': 'Aviso cuando recibes una respuesta',
    'settings.notif.likes':          '❤️ Me gusta',
    'settings.notif.likes.descr':    'Aviso cuando alguien da me gusta a tus posts',
    'settings.notif.mentions':       '@ Menciones',
    'settings.notif.mentions.descr': 'Aviso cuando te mencionan en el chat o en los posts',
    ...
    'community.editor.allega':    '📎 Adjuntar media',
    'community.editor.allega_caricamento': 'Subiendo…',
    'community.editor.allega_rimuovi': 'Quitar adjunto',
    'community.editor.allega_errore': 'Error al subir el media.',
    'community.editor.allega_troppo_grande': 'Archivo demasiado grande (máx ~4MB tras compresión).',
    ...
    'game.pausa':                 'Pausa',
    'game.pausa.riprendi':        '▶ Reanudar',
    'game.pausa.salva_esci':      '💾 Guardar y Salir',
    'game.pausa.esci':            '🚪 Salir sin guardar',
